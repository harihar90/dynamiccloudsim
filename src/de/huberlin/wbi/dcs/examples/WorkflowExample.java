		...
		try {
			...
			case C2O:
				...
				return new GreedyDataCenterBroker("C2O",vmPolicy,Parameters.tVms,Parameters.nVms, Parameters.taskSlotsPerVm, i);
					...
					return new GreedyDataCenterBroker_Opportunistic("C2O",vmPolicy,Parameters.tVms,Parameters.nVms, Parameters.taskSlotsPerVm, i, Parameters.recheck_interval, 0,10000 );
				else if(Parameters.game==Parameters.Gaming.BASIC_WITH_MIGRATION)
					return new GreedyDataCenterBroker_Migration("C2O",vmPolicy,Parameters.tVms,Parameters.nVms, Parameters.taskSlotsPerVm, i, Parameters.recheck_interval, 0,10000 );
				else
